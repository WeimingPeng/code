...
estimator='EKF';
feedback='';
place = 'C:\Users\tereseva\Dropbox\Master\TereseCode\MPC\3percent\EKF\';
state = 'state';
input= 'input';
output2= 'output';
...
% %% Initializing the ode solver and QP solver
M=eye(4);
...
%% =========== Extended Kalman Filter ===============
    ...
    yt = v4_new_4d_model(t(k),x_hat(:,k)+x0,u_in_noNoise(:,k),'measurements',par);
    y_hat(:,k) = yt;

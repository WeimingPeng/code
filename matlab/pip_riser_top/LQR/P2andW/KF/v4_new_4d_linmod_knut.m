...
%%
Psqrt = sqrt((P2-P0)*1e-5);
dPsqrt__dx1 = 0;
dPsqrt__dx2 = 0;
dPsqrt__dx3 = 1e-5*dP2__dx3/(2*Psqrt);
dPsqrt__dx4 = 1e-5*dP2__dx4/(2*Psqrt);
dPsqrt__du1 = 0;
dPsqrt__du2 = 0;
dPsqrt__du3 = 0;
%%
...
%%
DP_r = rho_m_av*g*L2 + DP_fr;
dDP_r__dx1 = g*L2*drho_m_av__dx1 + dDP_fr__dx1;
dDP_r__dx2 = g*L2*drho_m_av__dx2 + dDP_fr__dx2;
dDP_r__dx3 = g*L2*drho_m_av__dx3 + dDP_fr__dx3;
dDP_r__dx4 = g*L2*drho_m_av__dx4 + dDP_fr__dx4;
dDP_r__du1 = g*L2*drho_m_av__du1 + dDP_fr__du1;
dDP_r__du2 = g*L2*drho_m_av__du2 + dDP_fr__du2;
dDP_r__du3 = g*L2*drho_m_av__du3 + dDP_fr__du3;

%%
P2_b = P2 + DP_r;
dP2_b__dx1 = dP2__dx1 + dDP_r__dx1;
dP2_b__dx2 = dP2__dx2 + dDP_r__dx2;
dP2_b__dx3 = dP2__dx3 + dDP_r__dx3;
dP2_b__dx4 = dP2__dx4 + dDP_r__dx4;
dP2_b__du1 = dP2__du1 + dDP_r__du1;
dP2_b__du2 = dP2__du2 + dDP_r__du2;
dP2_b__du3 = dP2__du3 + dDP_r__du3;
...
C(4,:) =  [ dw_mix__dx1 dw_mix__dx2 dw_mix__dx3 dw_mix__dx4 ]; %[kg/s]
C([5 6],:) = 1e-5.*[dP2_b__dx1 dP2_b__dx2 dP2_b__dx3 dP2_b__dx4
                dDP_r__dx1 dDP_r__dx2 dDP_r__dx3 dDP_r__dx4]; %[bar]
C(7,:) = [drho_t__dx1 drho_t__dx2 drho_t__dx3 drho_t__dx4];
C(8,:) = [dAlpha_Lt__dx1 dAlpha_Lt__dx2 dAlpha_Lt__dx3 dAlpha_Lt__dx4];
C(9,:) = [dPsqrt__dx1 dPsqrt__dx2 dPsqrt__dx3 dPsqrt__dx4];

D = zeros(4,3);
D(3,:) = 1000*[dQ__du1 dQ__du2 dQ__du3 ];
D(4,:) = [ dw_mix__du1 dw_mix__du2 dw_mix__du3 ];
D([5 6],:) = 1e-5*[dP2_b__du1 dP2_b__du2 dP2_b__du3
                   dDP_r__du1 dDP_r__du1 dDP_r__du3];
D(7,:) =  [drho_t__du1 drho_t__du2 drho_t__du3];
D(8,:) =  [dAlpha_Lt__du1 dAlpha_Lt__du2 dAlpha_Lt__du3];
D(9,:) =  [dPsqrt__du1 dPsqrt__du2 dPsqrt__du3];
...
Gd11=(Gd({'P_wh','W_out'},'d1')); Gd12=(Gd({'P_wh','W_out'},'d2'));
sysm = sysc({'P_wh','W_out'},{'Z1','Z2'});
sysd = sysc({'P_wh','W_out'},{'d1','d2'});

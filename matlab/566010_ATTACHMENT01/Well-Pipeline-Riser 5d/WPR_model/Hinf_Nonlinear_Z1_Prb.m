...
Gd11=(Gd('P_rb','d1')); Gd12=(Gd('P_rb','d2'));
...
disp('Transfer function of H-infinity controller for P_rb')
zpk(K)
L1 = sysm*(K);
S1 = 1/(1+L1);
T1 = 1 - S1;
...
KSGd12 = R1*Gd12;
SG1 = S1*sysm;
disp('Poles of sensitivity transfer function of H-infinity controller for P_rb')
pole(S1)

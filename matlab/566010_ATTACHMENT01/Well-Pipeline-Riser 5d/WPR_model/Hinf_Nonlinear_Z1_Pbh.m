...
disp('Transfer function of H-infinity controller for P_bh')
zpk(K)
L1 = sysm1*(K);
S1 = 1/(1+L1);
T1 = 1 - S1;
...
KSGd12 = R1*Gd12;
SG1 = S1*sysm1;
disp('Poles of sensitivity transfer function of H-infinity controller for P_bh')
pole(S1)


omega = logspace(-6,2,100);

[mag,phase] = bode(sysm1,omega);
...
title('Mag. of transfer function form Z_1 to P_bh','FontSize',10,'FontWeight','bold','FontName','Times');
...
title('Mag. of controller gain form P_bh to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase. of transfer function form Z_1 to P_bh','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
title('Phase of controller form P_bh to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Mag. of the loop transfer function with P_bh','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase of the loop transfer function with P_bh','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
plot(t/3600,rPbh,'r',t/3600,Pbh,'k','Linewidth',linewidth);
legend('set-point','P_{bh}',1,'Orientation','Vertical')
xlim([0 t_f/3600])
ylim([-0.5 0.5])

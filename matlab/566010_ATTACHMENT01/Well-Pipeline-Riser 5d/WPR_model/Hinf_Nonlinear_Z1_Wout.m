...
Gd11=(Gd('W_out','d1')); Gd12=(Gd('W_out','d2'));
...
disp('Transfer function of H-infinity controller for W_out')
zpk(K)
L1 = sysm*(K);
S1 = 1/(1+L1);
T1 = 1 - S1;
...
KSGd12 = R1*Gd12;
SG1 = S1*sysm;
disp('Poles of sensitivity transfer function of H-infinity controller for W_out')
pole(S1)
...
title('Mag. of transfer function form Z_1 to P_rb','FontSize',10,'FontWeight','bold','FontName','Times');
...
title('Mag. of controller gain form P_rb to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase. of transfer function form Z_1 to P_rb','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
title('Phase of controller form P_rb to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Mag. of the loop transfer function with P_rb','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase of the loop transfer function with P_rb','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
sim('Hinf_Nonlinear_Z1_Wout_sim')
%%
t_f = t(end);
figure(7)
clf
...
plot(t/3600,rPrb,'r',t/3600,Wout,'k','Linewidth',linewidth);
legend('set-point','W_{out}',1,'Orientation','Vertical')
xlim([0 t_f/3600])
ylim([-0.6 0.5])

subplot(3,2,5)
set(gca,'FontSize',legsize,'OuterPosition',[0  0  0.5  1/3])
plot(t/3600,Pwh,'k','Linewidth',linewidth);
legend('P_{wh}',1,'Orientation','Vertical')
xlim([0 t_f/3600])
...
plot(t/3600,rPrb,'r',t/3600,Prb,'k','Linewidth',linewidth);
legend('set-point','P_{rb}',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
xlabel('Time [h]','FontSize',labelsize)
ylim([-0.5 0.5])
...
set(sys,'inputname',{'Z1','Z2','d1','d2'},'outputname',{'P_bh','P_wh','W_in','P_in','P_rb','DP_r','P_t','Q_out','W_out','Rho_t','Alpha_L'},'statename',{'m_Gw','m_Gp','m_Lp','m_Gr','m_Lr'});
sysc = minreal(sys);
sysm = minreal(sys({'P_wh','P_rb'},{'Z1','Z2'}));
...
Gd11=(Gd({'P_wh','P_rb'},'d1')); Gd12=(Gd({'P_wh','P_rb'},'d2'));
sysd = sysc({'P_wh','P_rb'},{'d1','d2'});
...
set(K,'inputname',{'P_wh','P_rb'},'outputname',{'Z1','Z2'});
disp('Gamma:')
disp(GAM)
...
K = minreal(K);
%%
sim('Hinf_MIMO_Nonlinear_Z1_PwhPrb_sim')
%%
t_f = t(end);
figure(7)
clf
...
plot(t/3600,Pt,'k','Linewidth',linewidth);
legend('P_{t}',1,'Orientation','Vertical')
xlim([0 t_f/3600])

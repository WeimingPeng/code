...
title('Mag. of transfer function form Z_1 to P_wh','FontSize',10,'FontWeight','bold','FontName','Times');
...
title('Mag. of controller gain form P_wh to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase. of transfer function form Z_1 to P_wh','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
title('Phase of controller form P_wh to Z_1','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Mag. of the loop transfer function with P_wh','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase of the loop transfer function with P_wh','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')

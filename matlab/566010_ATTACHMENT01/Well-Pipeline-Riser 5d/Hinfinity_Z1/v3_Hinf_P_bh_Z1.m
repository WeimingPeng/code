...
disp('Transfer function of H-infinity controller for Pb')
zpk(K)
L1 = sysm1*(K);
S1 = 1/(1+L1);
T1 = 1 - S1;
...
KSGd12 = R1*Gd12;
SG1 = S1*sysm1;
disp('Poles of S with H-infinity optimal controller for Pb')
pole(S1)
...
title('Mag. of transfer function form Z to P_b','FontSize',10,'FontWeight','bold','FontName','Times');
legend('|G_1|','G_{d1}','G_{d1}')
...
title('Mag. of controller gain form P_b to Z','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase. of transfer function form Z to P_b','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
...
title('Phase of controller form P_b to Z','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Mag. of the loop transfer function with P_b','FontSize',10,'FontWeight','bold','FontName','Times');
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')
xlim([1e-6 1e2])
...
title('Phase of the loop transfer function with P_b','FontSize',10,'FontWeight','bold','FontName','Times');
xlim([1e-6 1e2])
xlabel('\omega [Rad/s]','FontSize',10,'FontName','Times')

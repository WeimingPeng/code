...
Gd231=Gd({'P_t','Rho_t'},'d1'); Gd232=Gd({'P_t','Rho_t'},'d2');
sysm = sysc({'P_t','Rho_t'},'Z2');
sysd = sysc({'P_t','Rho_t'},{'d1','d2'});
...
set(K,'inputname',{'P_t','Rho_t'},'outputname','Z2');
disp('Gamma:')
disp(GAM)

...
Gd231=Gd({'P_t','W_out'},'d1'); Gd232=Gd({'P_t','W_out'},'d2');
sysm = sysc({'P_t','W_out'},'Z2');
sysd = sysc({'P_t','W_out'},{'d1','d2'});
...
set(K,'inputname',{'P_t','W_out'},'outputname','Z2');
disp('Gamma:')
disp(GAM)

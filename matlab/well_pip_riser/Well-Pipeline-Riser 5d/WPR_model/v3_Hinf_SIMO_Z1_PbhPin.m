...
Gd231=Gd({'P_bh','P_in'},'d1'); Gd232=Gd({'P_bh','P_in'},'d2');
sysm = sysc({'P_bh','P_in'},'Z1');
...
W3 = [Wt zeros(1,10)
  ...
  disp(GAM)
disp(INFO)
set(K,'inputname',{'P_bh','P_in'},'outputname','Z1');
disp('Gamma:')
disp(GAM)
...
subplot(3,2,1)
set(gca,'FontSize',8,'OuterPosition',[0  2/3  0.5  1/3])
plot(t/3600,z1,'b','Linewidth',1);
legend('Z_1',1,'Orientation','Horizontal')
...
subplot(3,2,2)
set(gca,'FontSize',8,'OuterPosition',[0.5  2/3  0.5  1/3])
plot(t/3600,d1,'r',t/3600,d2,'b','Linewidth',1);
legend('d_1', 'd_2',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
ylim([-1.1 1.1])

subplot(3,2,3)
set(gca,'FontSize',8,'OuterPosition',[0  1/3  0.5  1/3])
plot(t/3600,rPin,'r',t/3600,Pin,'b','Linewidth',1);
legend('set-point','W_{in}',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
ylim([-1 1])

subplot(3,2,4)
set(gca,'FontSize',8,'OuterPosition',[0.5  1/3  0.5  1/3])
plot(t/3600,rPbh,'r',t/3600,Pbh,'b','Linewidth',1);
legend('set-point','P_{bh}',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
ylim([-1 1])

subplot(3,2,5)
set(gca,'FontSize',8,'OuterPosition',[0  0  0.5  1/3])
plot(t/3600,Pin,'b','Linewidth',1);
legend('P_{in}',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
xlabel('time [h]')
ylim([-1 1])

subplot(3,2,6)
set(gca,'FontSize',8,'OuterPosition',[0.5  0  0.5  1/3])
plot(t/3600,Pt,'b','Linewidth',1);
legend('P_{t}',1,'Orientation','Horizontal')
xlim([0 t_f/3600])
xlabel('time [h]')
ylim([-1 1])